...
The NIJ database spanning 50 years of US mass shootings finds that **20% of all 167 mass shootings in that period occurred in the last five years of the study period** (2015–2019 alone). Annual death toll from mass shootings: average 8/year in the 1970s, rising to **51/year from 2010–2019**. A 6.4× increase in lethality per year. [World Finance](https://www.worldfinance.com/strategy/the-subscription-economy-slowdown)

School shootings specifically increased **90.4% from 2000 to 2022** — nearly doubling in two decades, with the steepest acceleration post-2012. [International Finance](https://internationalfinance.com/magazine/economy-magazine/subscription-fatigue-the-next-trend/)
...
The European Journal of Political Research (2025) finds that **deprived right-wing populists are significantly more likely to justify political violence** — specifically unemployed males with immigration status concerns. The mechanism: financial instability + perception of queue-jumping by others + loss of institutional trust → willingness to endorse violence as a legitimate political tool. [Deloitte Insights](https://www.deloitte.com/us/en/insights/industry/technology/digital-media-trends-consumption-habits-survey/2025.html)

The key finding from the multilevel European study is counterintuitive and structurally important: relative deprivation's association with right-wing populist voting is **strongest among high-income individuals in wealthy countries** — not the poorest cohorts. The perception of having been deprived of deserved status is more radicalizing than absolute poverty. [Amic](https://www.amic.media/media/files/file_352_2844.pdf)
...
**Tariff escalation as dead hand industrial policy:** The 2025 US tariff escalation — applied universally, without exemptions for supply chain realities — is structurally a dead hand move by a manufacturing sector that cannot compete through productivity improvement. Rather than accepting relative decline in low-value manufacturing and investing in higher-value production, the policy imposes costs on the entire economy to preserve specific industrial positions. The OECD projected global GDP to fall from 3.3% to 2.9% on tariff effects [Federal Reserve](https://www.federalreserve.gov/econres/notes/feds-notes/predicting-credit-card-delinquency-rates-20250228.html) — the dead hand extracts a broader economic cost to preserve specific political constituencies.
...
A government that knows its debt-to-GDP ratio will reach 140% by 2031, with net interest exceeding $2 trillion annually, has no legitimate positive agency pathway. It cannot:
...
The rate of school shootings increasing 90% from 2000 to 2022, correlated with income inequality (IRR 1.43–1.57, p<0.001), is a direct readout of the width of the gap between promised and delivered outcomes in the credentialing-debt-meritocracy system. As that gap widens — through the mechanisms documented across all prior modules — the dead hand activation rate at the base of the hierarchy increases. The cascade upward is not guaranteed but is structurally predisposed.
