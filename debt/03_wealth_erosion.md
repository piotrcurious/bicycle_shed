...
The most rigorous macro-level dataset for tracking real wealth (as opposed to GDP) is the World Bank's Changing Wealth of Nations (CWON) program, which monetizes produced capital, renewable natural capital, non-renewable natural capital, and human capital into a single comparable wealth metric.

**The key finding:** While real wealth per capita increased by approximately 21% globally between 1995 and 2020, renewable natural capital — driven by overexploitation of forests, marine fisheries, and wetlands — declined by more than **20%** over the same period. [LendingTree](https://www.lendingtree.com/credit-cards/study/credit-card-debt-statistics/) These two trends are *not* in tension — they are causally related. Produced capital increased partly *by converting* natural capital. The GDP growth that appears to validate debt serviceability is, in significant portion, a liquidation of non-reproducible assets booked as income.

27 of 151 countries in the CWON sample show a decline or near-zero change in real wealth per capita between 1995 and 2020 — primarily Sub-Saharan Africa. These countries are **depleting their asset portfolios faster than they are replenishing them**: the pattern of GDP growth funded by natural capital liquidation without reinvestment. [Federal Reserve](https://www.federalreserve.gov/econres/notes/feds-notes/predicting-credit-card-delinquency-rates-20250228.html)
...
Around **30% of the world's soils are moderately to highly degraded** (Soil Atlas 2024). 60% of EU soils are affected by at least one degradation process. If current trends continue, by 2050 more than **90% of Earth's land areas will be substantially degraded**, global crop yields will be reduced by an average of 10% (up to 50% in some regions), and 50–700 million people will be forced to migrate. [International Monetary Fund](https://www.imf.org/en/data)

The FAO *State of Food and Agriculture 2025* background paper establishes the causal link using a global causal forest model at 10km resolution: land degradation directly widens yield gaps, linking SDG Target 15.3 (soil degradation) causally to food security (SDG 2) and poverty (SDG 1). [International Monetary Fund](https://www.imf.org/en/publications/weo)
...
The OECD's December 2024 report *From Decline to Revival: Policies to Unlock Human Capital* explicitly identifies an overreliance on technology as reducing critical thinking skills, and attributes rising mental health disorders among teenagers partly to social media emergence and a decline in unstructured discovery play. Academic achievement is weakening across OECD countries via multiple pathways simultaneously: increased anxiety disorders, reduced attention capacity, technology-induced cognitive offloading, and weakened problem-solving development. [International Monetary Fund](https://www.imf.org/en/publications/fm/issues/2026/04/15/fiscal-monitor-april-2026)
...
The Lancet estimates total poor mental health costs the global economy **$2.5 trillion per year**, rising to **$6 trillion by 2030**. Depression and anxiety alone cost $1 trillion annually in lost productivity. [IMF](https://www.imf.org/external/datamapper/GDD/2025%20Global%20Debt%20Monitor.pdf)

Untreated mental illness costs the US economy approximately **$477.5 billion as of 2024**. Cumulative projection to 2040: **$14 trillion** — averaging $282 billion/year, equivalent to 1.7% of GDP per annum, *the cost of an average recession, every year*, indefinitely. 91% of Gen Z workers grappled with mental health challenges in the past year. [International Monetary Fund](https://www.imf.org/en/topics/sovereign-debt)
...
The economic cost of unaddressed mental illness accounts for **8% of GDP in North America**. The US government's 2025 USAID funding cuts reduced mental health training recipients from 55,911 to 5,908 in one year — an **89% reduction** in global mental health workforce pipeline, simultaneously with accelerating demand. [IMF](https://www.imf.org/external/datamapper/GGXWDG_NGDP@WEO/OEMDC/ADVEC/WEOWORLD)
...
A Graphite analysis of 65,000 URLs from CommonCrawl (covering 18 years of web content, 300+ billion pages) found that by **November 2024, AI-generated articles surpassed human-written articles in volume** on the web. The inflection is precisely dated to ChatGPT's launch in November 2022 — a 24-month transition from a predominantly human-written to a predominantly AI-generated web. [World Economic Forum](https://www.weforum.org/stories/2025/10/cost-productivity-gains-cfo-ai-investment/)

Ahrefs analysis of nearly one million new web pages published in April 2025 found **74.2% contained detectable AI-generated content**. This is the most comprehensive crawl-based measurement available. TikTok has labeled more than **1.3 billion AI-generated videos**. [Unsw](https://www.businessthink.unsw.edu.au/articles/ai-return-on-investment-measurement-productivity-business-value)

**Inference, Iteration 3 — The Gresham's Law dynamic:**

A 2026 AAAI paper formalizes the economics: API costs for generative AI have fallen over **90% in two years**, while annual economic losses from disinformation exceed **$100 billion**. The asymmetry — near-zero production cost for low-quality content, unchanged production cost for high-quality content — produces the Gresham's Law dynamic: the market for information cannot distinguish quality at the point of consumption, so cheap production floods the market, crowds out expensive production, and average quality collapses. [World Bank](https://www.worldbank.org/en/programs/debt-statistics)
...
By April 2025, 74.2% of newly created webpages contained AI-generated text. AI-written pages in the top-20 Google results climbed from 11.11% to **19.56%** between May 2024 and July 2025. This means the training data scraped from tomorrow's web will be substantially synthetic — feeding model collapse in the next training cycle. [Infographic Website](https://infographicsite.com/infographic/oecd-countries-wage-growth-comparison/)

### Layer 3.3: The Search Quality Collapse — Destruction of Navigation Capital

Google handled over 5 trillion searches in 2024. AI Overviews now appear in 43.6% of science queries, 43.0% of health queries, and 35.3% of people and society queries. [McKinsey & Company](https://www.mckinsey.com/capabilities/tech-and-ai/our-insights/superagency-in-the-workplace-empowering-people-to-unlock-ais-full-potential-at-work) These are the highest-stakes, highest-harm potential categories for AI-generated error.
...
The USAID mental health funding cut — from 55,911 to 5,908 people receiving training in one year — is a direct example of this pattern applied to the international aid architecture: built over decades at high cost, used to extract geopolitical soft power, then defunded when the soft power calculus changed, leaving 750,000 previously served beneficiaries immediately without care. [IMF](https://www.imf.org/external/datamapper/GGXWDG_NGDP@WEO/OEMDC/ADVEC/WEOWORLD)
...
| Mental health productivity loss | $2.5T/year globally, $477B/year US | WHO 2025, Lancet, Michigan J. Economics 2025 |
| Information ecosystem degradation (disinformation costs) | $100B+/year direct, incalculable indirect | AAAI 2026 |
...
91% of Gen Z workers in the US experienced mental health challenges in the past year. [International Monetary Fund](https://www.imf.org/en/topics/sovereign-debt) This cohort will carry the primary productive burden of the US economy for the next 40 years. They are already compromised by the combination of economic precarity, information ecosystem degradation, social isolation, and debt stress — before they peak in the workforce.

**Feedback 4: Institutional trust decline → policy gridlock → inability to address any crisis → further trust decline**
44% of OECD residents have low or no trust in national government [IMF Media Center](https://mediacenter.imf.org/news/imf---fiscal-monitor-press-briefing/s/1e2b7da4-937a-4aa1-a3f8-52c83290d049) — the coordination mechanism required to address every problem in this analysis. Trust decline is simultaneously a consequence of all the other problems and a cause of inability to solve them.
...
A recession in 2027–2029 (likely given tariff shock + AI ROI gap + sovereign refinancing cliff) triggers:
