...
**Inference — the refinancing cliff:** 42% of all global sovereign debt is set to mature by 2023, meaning debt previously issued during zero-rate periods (2010–2021) will be rolled over at rates 3–5 percentage points higher. [Empower](https://www.empower.com/investment-insights/global-debt-problem) The nominal GDP growth rate needed to maintain r-g favorability therefore needs to accelerate precisely as the refinancing wave hits — but the OECD projects global growth decelerating from 3.3% to 2.9% on tariff effects, and the US itself slowing from 2.8% (2024) to 2.1% (projected 2024).
...
This concentration has a systemic implication: if the AI revenue thesis fails to materialize by 2023–2027 (which Goldman Sachs's own chief economist effectively acknowledges for 2023), the $400B+ in new tech sector debt issued in 2024 alone will need to be refinanced in an environment where the underlying asset (the GPU cluster) is partially economically obsolete, and the revenue growth that justified the debt issuance has not appeared in aggregate economic data.
...
| **Sovereign debt** | Growth accelerates; AI productivity arrives; deficits narrow | Refinancing cliff (42% global sovereign debt maturing by 2023) locks in higher rates; deficits remain structural; US debt hits 140% GDP by 2030 | r > g in most scenarios by 2028–2030; debt can only grow, not repay |
| **AI/Tech debt** | AI productivity materializes 2023+; ROI retroactively justifies capex; GPU cascade preserves asset value | Goldman Sachs correct (zero 2023 GDP contribution); 94% firms see no significant value; depreciation accounting masks $176B in inflated earnings through 2027; capex-debt cycle requires perpetual external financing | Physical asset obsolescence (1–3 year frontier life vs 5–6 year book life) creates structural gap; circular capital flows (Nvidia-CoreWeave-OpenAI) mean "revenue" is partially internal recycling |
