...
The average new car loan balance reached **$43,582** in Q4 2025 for new vehicles and $27,528 for used. The average new car payment hit a record **$767/month**. Average auto loan term: **68.9 months** (new) and **67.7 months** (used) — essentially 6-year loans on depreciating assets. [Experian State of the Automotive Finance Market Q4 2025](https://www.experianplc.com/newsroom/press-releases/2026/new-report-from-experian-automotive-highlights-growth-in-subprim) Independent data from TransUnion confirms the average amount financed on new auto loans remained elevated at **$42,023** by Q4 2024. [TransUnion](https://www.transunion.com/blog/q4-2024-credit-industry-insights-report)
...
The root cause was Computer Science 101 error handling that no one implemented — a missing array bounds check that passed through CrowdStrike's entire deployment pipeline including their validation system. A validation system with a logic error that it was designed to catch in others. [CrowdStrike External Root Cause Analysis (2024)](https://www.crowdstrike.com/wp-content/uploads/2024/08/External-Root-Cause-Analysis-July-19-2024.pdf)
